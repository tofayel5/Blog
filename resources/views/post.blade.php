                        ...
                        <div class="card h-100">
                            <div class="single-post post-style-1">
                                ...
                                <div class="blog-image"><img src="{{ asset('storage/post/'.$randompost->image) }}"
                                                             alt="{{ $randompost->title }}" alt="Blog Image"></div>
                                        ...
                                        <li>
                                            ...
                                            @else
                                                <a href="javascript:void(0)"
                                                   ...
                                                   class="{{ Auth::user()->favorite_posts->where('pivot.post_id',$randompost->id)->count() == 1 ? 'favorite_posts' : '' }}">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-12">
                    <div class="comment-form">
                        @guest
                            <p>For post a new comment.You need login first.<a href="{{ route('login') }}">Login</a></p>
                        @else
